                    ...
                    <div class="roadmap-timeline">
                        ...
                        <div class="roadmap-phase">
                            ...
                            <div class="phase-content">
                                <h3>Fase 1: Penguatan Fondasi</h3>
                        ...
                        <div class="roadmap-phase">
                            ...
                            <div class="phase-content">
                                <h3>Fase 2: Pengembangan dan Inovasi</h3>
                                <div class="phase-details">
                                    <h4>Tujuan Strategis:</h4>
                                    <ul>
                        ...
                        <div class="roadmap-phase">
                            ...
                            <div class="phase-content">
                                <h3>Fase 3: Ekspansi dan Dampak</h3>
                                <div class="phase-details">
                                    <h4>Tujuan Strategis:</h4>
                                    <ul>
                        ...
                        <!-- Phase 4 -->
                        <div class="roadmap-phase">
                            <div class="phase-marker phase-4">
                                <span>2034-2035</span>
                            </div>
                            <div class="phase-content">
                                <h3>Fase 4: Keberlanjutan dan Kepemimpinan</h3>
                                <div class="phase-details">
                                    <h4>Tujuan Strategis:</h4>
                                    <ul>
                        ...
                        <table class="roadmap-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Internasional terindeks</td>
                                    <td>High impact journal</td>
                                    <td>Book series internasional</td>
                                </tr>
                                <tr>
...
.phase-marker.phase-1 { background: var(--primary-color); }
.phase-marker.phase-2 { background: var(--primary-light); }
.phase-marker.phase-3 { background: var(--secondary-color); }
.phase-marker.phase-4 { background: #a15526; }
